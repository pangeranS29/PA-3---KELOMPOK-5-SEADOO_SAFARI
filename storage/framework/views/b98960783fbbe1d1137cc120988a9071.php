...
<body>
            ...
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center">
                    ...
                    <a href="<?php echo e(route('front.index')); ?>" class="flex items-center">
                        <img src="<?php echo e(asset('images/logoseado.png')); ?>" alt="Logo"
                        ...
                        <div class="flex items-center space-x-6">
                            ...
                            <div class="relative group" x-data="{ open: false }">
                                ...
                                <div x-show="open" @click.outside="open = false" x-cloak
                                    ...
                                    <div class="py-1">
                                        <?php $__currentLoopData = \App\Models\PilihPaket::with([
        'detail_paket' => function ($query) {
            $query->limit(1);
        },
    ])->has('detail_paket')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('front.detail', $paket->detail_paket->first()->id)); ?>"
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <div x-show="open" @click.outside="open = false" x-cloak
                                        ...
                                        <div class="max-h-96 overflow-y-auto">
                                            ...
                                            <template x-for="berita in notifications" :key="berita.id">
                                                <a :href="'<?php echo e(route('front.berita.show', '')); ?>/' + berita.slug"
                                ...
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" @click.outside="open = false" x-cloak
                                        ...
                                        <div class="py-1">
                                            <a href="<?php echo e(url('account?tab=profile')); ?>"
                                            ...
                                            <a href="<?php echo e(url('account?tab=transaction')); ?>"
                                                class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 transition-colors duration-200">
    ...
    <ul class="space-y-3 mt-4">
        ...
        <div class="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400 text-sm">
            <p>&copy; <?php echo e(date('Y')); ?> Seadoo Safari. All rights reserved.</p>
        </div>
    </div>
</footer>
    ...
    <script>
        ...
        function notificationDropdown() {
            return {
                ...
                fetchNotifications() {
                    this.isLoading = true;
                    fetch('<?php echo e(route('front.api.berita.latest')); ?>', {
                            headers: {
                ...
                markAllAsRead() {
                    fetch('<?php echo e(route('front.api.berita.markAllAsRead')); ?>', {
                            method: 'POST',
                            headers: {
...
<?php /**PATH C:\laragon\www\PA3\PA-3---KELOMPOK-5-SEADOO_SAFARI\PA3\PA3\resources\views/layouts/front.blade.php ENDPATH**/ ?>