                                ...
                                <div class="bg-gray-700/50 rounded-lg p-4 border border-gray-600">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-white">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium">{{ $booking->detail_paket->pilihpaket->nama_paket }}</p>
                                        </div>
                                        <div>
                                            <p class="text-gray-400 text-sm">Durasi</p>
                                            <p class="font-medium">{{ $booking->detail_paket->pilihpaket->durasi }} Menit</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                @case('expire')
                                    <div class="bg-red-600 text-white p-4 rounded mb-6">
                                        <div class="flex items-center">
                                            ...
                                            <span>Pembayaran Anda <strong>kadaluarsa</strong>. Silakan lakukan pemesanan ulang.</span>
                                        </div>
                                    </div>
                                ...
                                @default
                                    @if ($booking->metode_pembayaran === 'midtrans' && $booking->url_pembayaran)
                                        <div class="bg-yellow-400 text-black p-4 rounded mb-6">
                                            <div class="flex items-center">
                                                ...
                                                <span>Pembayaran Anda belum selesai. Silakan lanjutkan melalui tombol di bawah ini.</span>
                                            </div>
                                        </div>
                                    ...
                                    @else
                                        ...
                                        <form action="{{ route('front.payment.update', $booking->id) }}" method="POST" id="payment-form">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <label for="manual_transfer"
                                                            ...
                                                            <img src="{{ asset('svgs/bank.svg') }}" alt="Manual Transfer" class="h-10 mb-2">
                                            ...
                                            <!-- Payment Instruction -->
                                            <div id="payment-instruction" class="hidden mb-6 bg-gray-700/50 rounded-lg p-4 border border-gray-600">
